// Code generated by go generate on 2021-09-28 14:47:25.975010707 +0000 UTC
package main
...
type ArrayInt interface {
	...
	Filter(func(int)bool) arrayInt
	Find(func(int) bool) ResultInt 
...
type ArrayNode interface {
	...
	Filter(func(Node)bool) arrayNode
	Find(func(Node) bool) ResultNode 
...
type ArrayString interface {
	...
	Filter(func(string)bool) arrayString
	Find(func(string) bool) ResultString 
...
func (a arrayInt) At(i int) ResultInt {
	if len(a) == 0 {
		return ErrInt("Empty Array")
	}
	if i < 0 || i >= len(a) {
...
// Filter with arrayInt receiver
// returns a filtered array 
func (a arrayInt) Filter(f func(int) bool) arrayInt {
	r := make([]int, 0)
	...
	return ArrayIntFrom(r...)
}

// Find with arrayInt receiver
// returns a ResultInt as soon as item is found 
func (a arrayInt) Find(f func(int) bool) ResultInt {
	for _, e := range a.Slice() {
		if f(e) {
			return OkInt(e)
		}
	}
	return ErrInt("Int Not Found")
}
...
func (a arrayNode) At(i int) ResultNode {
	if len(a) == 0 {
		return ErrNode("Empty Array")
	}
	if i < 0 || i >= len(a) {
...
// Filter with arrayNode receiver
// returns a filtered array 
func (a arrayNode) Filter(f func(Node) bool) arrayNode {
	r := make([]Node, 0)
	...
	return ArrayNodeFrom(r...)
}

// Find with arrayNode receiver
// returns a ResultNode as soon as item is found 
func (a arrayNode) Find(f func(Node) bool) ResultNode {
	for _, e := range a.Slice() {
		if f(e) {
			return OkNode(e)
		}
	}
	return ErrNode("Node Not Found")
}
...
func (a arrayString) At(i int) ResultString {
	if len(a) == 0 {
		return ErrString("Empty Array")
	}
	if i < 0 || i >= len(a) {
...
// Filter with arrayString receiver
// returns a filtered array 
func (a arrayString) Filter(f func(string) bool) arrayString {
	r := make([]string, 0)

	a.Each(func(e string) {
		if f(e) {
			r = append(r, e)
		}
	})

	return ArrayStringFrom(r...)
}

// Find with arrayString receiver
// returns a ResultString as soon as item is found 
func (a arrayString) Find(f func(string) bool) ResultString {
	for _, e := range a.Slice() {
		if f(e) {
			return OkString(e)
		}
	}
	return ErrString("String Not Found")
}
