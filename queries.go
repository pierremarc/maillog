...
func RegisterQueries(store Store) {
	...
	store.Register(QuerySelectRecordsTopicSince, base64decodeSql(`U0VMRUNUICAKICAgIGlkLCB0cywgc2VuZGVyLCB0b3BpYywgaGVhZGVyX3N1YmplY3QsIGJvZHkgCkZST00ge3suUmVjb3Jkc319IApXSEVSRSAKICAgIGRvbWFpbiA9ICQxCiAgICBBTkQgdG9waWMgPSAkMgogICAgQU5EIHRzID49ICQzOjpkYXRl`))
